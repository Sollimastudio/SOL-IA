import { SOL_PRESENCE_PROFILE, SOL_PRESENCE_PROFILE_VERSION } from './presence-profile.mjs';

// Shared instructions, deliberately free of private biography and credentials.
export const SOLIA_PROMPT_AUTOPILOT_VERSION = '2026-09-14.1';
...
PRESENCA_PROFILE_VERSION=${SOL_PRESENCE_PROFILE_VERSION}`;
